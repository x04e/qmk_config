...
/* --- */
#define _V_M      LT(LAYER_LEFT_ARROW, _V)
#define _M_M      LT(LAYER_RIGHT_NUMBER, _M)

/* Other mods */
#define _UPPR     LT(0, KC_NO)
#define _SPC_COM  LT(0, _SPC)
#define _BSP_DOT  LT(0, _BSPC)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LAYER_QWERTY] = LAYOUT( \
     /* ────────── ────────── ────────── ────────── ──────────|────────── ────────── ────────── ────────── ────────── */
        ...
        _Z,        _X,        _C,        _V_M,      _B,        _N,        _M_M,      _SPC_COM,  _BSP_DOT,  _SL      \
    ),
    ...
    [LAYER_LEFT_SYMBOL] = LAYOUT( \
     /* ─────── ─────── ─────── ─────── ───────|─────── ─────── ─────── ─────── ─────── */
        ...
        _UPPR,  LADJ,   xxx,    _ENT,   _DEL,   _RPR,   _DQT,   _USD,   _EX,    xxx,    \
