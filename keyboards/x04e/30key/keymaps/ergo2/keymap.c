...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LAYER_LEFT_SYMBOL] = LAYOUT( \
     /* ─────── ─────── ─────── ─────── ───────|─────── ─────── ─────── ─────── ─────── */
        xxx,    xxx,    xxx,    xxx,    _AT,    _RSB,   _PLS,   _AMP,   _LAB,   _DEL,   \
        xxx,    LADJ,   xxx,    xxx,    _EX,    _RPR,   _DQT,   _USD,   _RAB,    _BSPC,  \
        xxx,    xxx,    xxx,    xxx,    xxx,    _RCB,   _EQ,    _AST,   _HSH,   _ENT    \
    ),

    [LAYER_RIGHT_SYMBOL] = LAYOUT( \
     /* ─────── ─────── ─────── ─────── ───────|─────── ─────── ─────── ─────── ─────── */
        _TAB,   _BTK,   _PIP,   _UND,   _LSB,   _GBP,   xxx,   xxx,    xxx,    xxx,    \
        _ESC,   _PRC,   _SQT,   _MIN,   _LPR,   _EUR,   xxx,   xxx,    RADJ,   xxx,    \
        _UPPR,  _CRT,   _BSL,   _TLD,   _LCB,   xxx,    xxx,   xxx,    xxx,    xxx     \
    ),
    ...
    [LAYER_LEFT_ADJUST] = LAYOUT( \
     /* ─────── ─────── ─────── ─────── ───────|─────── ─────── ─────── ─────── ─────── */
        ...
        xxx,    TRNS,   TRNS,   xxx,    xxx,    _F12,   _V_P,   _V_VD,  _V_VU,  xxx,    \
    ...
    [LAYER_RIGHT_ADJUST] = LAYOUT( \
     /* ─────── ─────── ─────── ─────── ───────|─────── ─────── ─────── ─────── ─────── */
        ...
        xxx,    _V_VD,  _V_VU,  _V_P,   _F11,   xxx,    xxx,    TRNS,   TRNS,   xxx,    \
