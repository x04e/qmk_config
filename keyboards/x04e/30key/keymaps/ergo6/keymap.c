...
#define _W_M      LT(LAYER_LEFT_SYMBOL, _W)
#define _O_M      LT(LAYER_RIGHT_SYMBOL, _O)
#define _P_M      LGUI_T(_P)
/* --- Row 2 --- */
#define _A_M      LSFT_T(_A)
#define _S_M      LT(LAYER_LEFT_ARROW, _S)
#define _L_M      LT(LAYER_RIGHT_NUMBER, _L)
#define _SCN_M    LSFT_T(_SCN)
/* --- Row 3 --- */
#define _Z_M      LALT_T(_Z)
#define _X_M      LCTL_T(_X)
#define _DOT_M    LCTL_T(_DOT)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LAYER_QWERTY] = LAYOUT( \
     /* ─────── ─────── ─────── ─────── ───────|─────── ─────── ─────── ─────── ─────── */
        _Q_M,   _W_M,   _E,     _R,     _T,     _Y,     _U,     _I,     _O_M,   _P_M,    \
        _A_M,   _S_M,   _D,     _F,     _G,     _H,     _J,     _K,     _L_M,   _SCN_M,  \
        _Z_M,   _X_M,   _C,     _V,     _B,     _N,     _M,     _SPC_M, _DOT_M, _SL_M    \
    ),

    [LAYER_LEFT_ARROW] = LAYOUT( \
     /* ─────── ─────── ─────── ─────── ───────|─────── ─────── ─────── ─────── ─────── */
        xxx,    xxx,    xxx,    xxx,    xxx,    _DEL,   xxx,    xxx,    xxx,    xxx,    \
        xxx,    xxx,    LADJ,   xxx,    xxx,    _BSPC,  _AR_L,  _AR_D,  _AR_U,  _AR_R,  \
        xxx,    xxx,    xxx,    xxx,    xxx,    _ENT,   _HOME,  _PG_D,  _PG_U,  _END    \
    ),

    [LAYER_RIGHT_NUMBER] = LAYOUT( \
     /* ─────── ─────── ─────── ─────── ───────|─────── ─────── ─────── ─────── ─────── */
        xxx,    _7,     _8,     _9,     _TAB,   xxx,    xxx,    xxx,    xxx,    xxx,    \
        _0,     _4,     _5,     _6,     _ESC,   xxx,    xxx,    RADJ,   xxx,    xxx,    \
        xxx,    _1,     _2,     _3,     _UPPR,  xxx,    xxx,    xxx,    xxx,    xxx     \
    ),

    [LAYER_LEFT_SYMBOL] = LAYOUT( \
     /* ─────── ─────── ─────── ─────── ───────|─────── ─────── ─────── ─────── ─────── */
        xxx,    xxx,    xxx,    xxx,    xxx,    _RSB,   _PLS_M, _AMP_M, _LAB,   _DEL,   \
        xxx,    xxx,    LADJ,   xxx,    xxx,    _RPR,   _DQT,   _USD,   _RAB,   _BSPC,  \
    ...
    [LAYER_RIGHT_SYMBOL] = LAYOUT( \
     /* ─────── ─────── ─────── ─────── ───────|─────── ─────── ─────── ─────── ─────── */
        ...
        _ESC,   _EX,    _SQT,   _MIN,   _LPR,   xxx,    xxx,    RADJ,   xxx,    xxx,    \
        _UPPR,  _AT,    _BSL,   _TLD,   _LCB,   xxx,    xxx,    xxx,    xxx,    xxx     \
    ),
...
void process_capslock(uint16_t keycode, keyrecord_t *record){
    ...
    switch(keycode) {
        ...
        case _Q_M: case _W_M: case _O_M: case _P_M:
