...
#define _D_M      LCTL_T(_D)
#define _F_M      LSFT_T(_F)
#define _J_M      LSFT_T(_J)
#define _K_M      LCTL_T(_K)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LAYER_LEFT_SYMBOL] = LAYOUT( \
     /* ─────── ─────── ─────── ─────── ─────── ───────|─────── ─────── ─────── ───────  ─────── ─────── */
        ...
        xxx,    xxx,    LADJ,   xxx,    _BSPC,   _UPPR,  _RPR,   _DQT,   _USD,   _RAB,    xxx,     xxx,   \
        xxx,    xxx,    xxx,    xxx,    _ESC,    xxx,    _RCB,   _EQ,    _AST,   _HSH,    _EX,     xxx    \
    ),

    [LAYER_RIGHT_SYMBOL] = LAYOUT( \
     /* ─────── ─────── ─────── ─────── ─────── ───────|─────── ─────── ─────── ───────  ─────── ─────── */
        xxx,    _GBP,   _BTK,   _PIP,   _UND,   _LSB,   xxx,    _DEL,   xxx,    xxx,     xxx,    xxx,    \
        xxx,    xxx,    _PRC,   _SQT,   _MIN,   _LPR,   _UPPR,  _BSPC,  xxx,    RADJ,    xxx,    xxx,    \
        xxx,    _EUR,   _CRT,   _BSL,   _TLD,   _LCB,   xxx,    _ENT,   xxx,    xxx,     xxx,    xxx     \
    ),

    [LAYER_LEFT_ARROW] = LAYOUT( \
     /* ─────── ─────── ─────── ─────── ─────── ───────|─────── ─────── ─────── ───────  ─────── ─────── */
        xxx,    xxx,    xxx,    xxx,    _TAB,   xxx,    xxx,    xxx,    xxx,    xxx,     xxx,    xxx,    \
        xxx,    xxx,    xxx,    LADJ,   _BSPC,  _UPPR,  xxx,    _AR_L,  _AR_D,  _AR_U,   _AR_R,  xxx,    \
        xxx,    xxx,    xxx,    xxx,    _ESC,   xxx,    xxx,    _HOME,  _PG_D,  _PG_U,   _END,   xxx     \
    ),

    [LAYER_RIGHT_NUMBER] = LAYOUT( \
     /* ─────── ─────── ─────── ─────── ─────── ───────|─────── ─────── ─────── ───────  ─────── ─────── */
        xxx,    xxx,    _7,     _8,     _9,     xxx,    xxx,    _DEL,   xxx,    xxx,     xxx,    xxx,    \
        xxx,    _0,     _4,     _5,     _6,     xxx,    _UPPR,  _BSPC,  xxx,    RADJ,    xxx,    xxx,    \
        xxx,    xxx,    _1,     _2,     _3,     xxx,    xxx,    _ENT,   xxx,    xxx,     xxx,    xxx     \
    ),
