...
/* --- Row 3 --- */
/* --- Row 4 --- */
#define LTHM1     LCTL_T(_DEL)
#define LTHM2     LT(NUMARR, _SPC)
#define RTHM2     LT(SYMBOL, _BSPC)
#define RTHM1     LSFT_T(_ENT)
/**/
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [QWERTY] = LAYOUT( \
     /* ─────── ─────── ─────── ─────── ─────── ───────|─────── ─────── ─────── ─────── ─────── ─────── */
        ...
        xxx,    xxx,    xxx,    xxx,    LTHM1,  LTHM2,  RTHM2,  RTHM1,  xxx,    xxx,    xxx,    xxx     \
    ),

    [SYMBOL] = LAYOUT( \
     /* ─────── ─────── ─────── ─────── ─────── ───────|─────── ─────── ─────── ─────── ─────── ─────── */
        xxx,    _TAB,   _BTK_M, _PIP,   _UND,   _LSB,   _RSB,   _PLS,   _AMP,   _LAB_M, _TAB,   xxx,    \
        xxx,    _ESC,   _EX,    _SQT,   _MIN,   _LPR,   _RPR,   _DQT,   _USD,   _RAB,   _ESC,   xxx,    \
        xxx,    _UPPR,  _AT_M,  _BSL,   _TLD,   _LCB,   _RCB,   _EQ,    _AST,   _HSH_M, _UPPR,  xxx,    \
        xxx,    xxx,    xxx,    xxx,    ___,    ADJ,    ___,    ___,    xxx,    xxx,    xxx,    xxx     \
    ),

    [NUMARR] = LAYOUT( \
     /* ─────── ─────── ─────── ─────── ─────── ───────|─────── ─────── ─────── ─────── ─────── ─────── */
        xxx,    xxx,    _7,     _8,     _9,     xxx,   xxx,    xxx,    xxx,    xxx,    xxx,    xxx,    \
        xxx,    _0,     _4,     _5,     _6,     xxx,   xxx,    _AR_L,  _AR_D,  _AR_U,  _AR_R,  xxx,    \
        xxx,    xxx,    _1,     _2,     _3,     xxx,   xxx,    _HOME,  _PG_D,  _PG_U,  _END,   xxx,    \
        xxx,    xxx,    xxx,    xxx,    ___,    ___,   ADJ,    ___,    xxx,    xxx,    xxx,    xxx     \
    ),
...
void process_capslock(uint16_t keycode, keyrecord_t *record){
    ...
    switch(keycode) {
        ...
        case _Q_M: case _P_M: case _A_M: case _S_M: case _L_M:
