...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [QWERTY] = LAYOUT( \
     /* ─────── ─────── ─────── ─────── ─────── ───────|─────── ─────── ─────── ─────── ─────── ─────── */
        ...
        xxx,    _A_M,   _S_M,   _D_M,   _F,     _G,     _H,     _J,     _K_M,   _L_M,   _BSPC_M,xxx,    \
        xxx,    _Z,     _X,     _C,     _V,     _B,     _N,     _M,     _COM,   _DOT,   _ENT,   xxx,    \
        xxx,    xxx,    xxx,    xxx,    LWR,    _SPC,   _GUI_M, RSE,    xxx,    xxx,    xxx,    xxx     \
    ),

    [LOWER] = LAYOUT( \
     /* ─────── ─────── ─────── ─────── ─────── ───────|─────── ─────── ─────── ─────── ─────── ─────── */
        xxx,    xxx,    _7,     _8,     _9,     xxx,    _RSB,   _PLS,   _AMP,   _PRC,   _DEL,   xxx,    \
        xxx,    _0,     _4,     _5,     _6,     xxx,    _RPR,   _DQT,   _USD,   _SL,    _SCN,   xxx,    \
        xxx,    xxx,    _1,     _2,     _3,     xxx,    _RCB,   _EQ,    _AST,   _HSH_M, _QS,    xxx,    \
    ...
    [ADJUST] = LAYOUT( \
     /* ─────── ─────── ─────── ─────── ─────── ───────|─────── ─────── ─────── ─────── ─────── ─────── */
        ...
        xxx,    _CAPS,  xxx,    xxx,    xxx,    xxx,    xxx,    xxx,    xxx,    xxx,    _CAPS,  xxx,    \
